...
$(document).ready(()=>{
                ...
                init: function(){
                    ...
                    this.on(
                        "addedfile", function(file) {
                          ...
                          file._captionBox = Dropzone.createElement("<input style='width: 120px;' id='"+file.filename+"' type='text' name='caption[]' value="+caption+" >");
                    ...
                    this.on("sendingmultiple", function(data, xhr, formData) {
                        ...
                        formData.append("filesCaption", $("#formCreateResortFacility").serialize());
    ...
    // ********************* form validation ***********
      ...
      $("#formCreateResortFacility").validate({
