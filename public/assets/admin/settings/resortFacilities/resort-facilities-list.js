...
$(document).ready(function () {
  ...
  var table = $('#tblResortFacilities').DataTable({
    lengthChange: false,
    dom: 'Bfrtip',
    buttons: ['copy', 'excel', 'pdf', 'csv' , 'colvis'],

    ajax: {
        "url": "/admin/resort-facility/datatable",
        "dataSrc": ""
    },
    columns: [
      { data : 'id'},
      { data: "resort_facility_id"},
      { data: "title"},
      { data: "hotel.name"},
     ...
     { render : function(data, type, row , full) {
         ...
         <div class="glyph">
             ...
             <a href="/admin/resort-facility/`+row.id+`"> <i class="mdi mdi-file-eye"></i> </a>
         </div>
