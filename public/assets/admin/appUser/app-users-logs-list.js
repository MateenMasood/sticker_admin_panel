...
$(document).ready(function () {
  ...
  var table = $('#tblAppUsersLog').DataTable({
    lengthChange: false,
    dom: 'Bfrtip',
    buttons: ['copy', 'excel', 'pdf', 'csv' , 'colvis' , 'print'],

    ajax: {
        "url": "/admin/app-user-log/datatable",
        "dataSrc": ""
    },
    columns: [
      { data : 'id'},
            ...
            $.ajax({
                ...
                success: (response)=>{
                        Swal.fire({
                            ...
                            window.location.href = window.location.protocol + '//' + window.location.hostname +":"+window.location.port+"/admin/app-user-log/";
                        });
