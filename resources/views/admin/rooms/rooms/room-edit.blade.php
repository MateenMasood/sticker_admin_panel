    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Edit Room</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formCreateRoom" id="formEditRoom">
                        @csrf
                      <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="hotel" name="hotel" reequired>
                                    <option value="{{ $roomSingleRecord->roomType->hotel->id }}"> {{ $roomSingleRecord->roomType->hotel->name }} </option>
                                    <option value=""> </option>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="roomType" name="roomType" id="roomType" required>
                                    <option value="{{ $roomSingleRecord->roomType->id }}"> {{ $roomSingleRecord->roomType->room_type_name }} </option>
                                    <option value=""> </option>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Floor </label>
                            <input type="text" class="form-control" placeholder="Please enter enetr floor here" name="floor" value="{{ $roomSingleRecord->floor }}"/>
                        </div>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/rooms/rooms/room-edit.js') }}"></script>
