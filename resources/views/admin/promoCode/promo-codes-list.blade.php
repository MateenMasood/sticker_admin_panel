    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Coupons List</h4>
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                ...
                <div class="dropdown">
                    <a href="{{ url('admin\promo-code\create')}}"><button class="btn btn-primary " type="button"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="mdi mdi-settings mr-2"></i> Create Coupon
                    </button> </a>
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/promoCode/promo-code-list.js') }}"></script>
