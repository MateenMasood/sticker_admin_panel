    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Create Permission</h4>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">S Chalet</a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Settings List</a></li>
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);"> Permissions List</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formCreatePermission" id="formCreatePermission">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required placeholder="Please enter permission here" name="permission"/>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/settings/rbac/permissions/permission-create.js') }}"></script>
