        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formCreateRole" id="formCreateRole">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" required placeholder="Please user role  here" name="role"/>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/settings/rbac/roles/role-create.js') }}"></script>
