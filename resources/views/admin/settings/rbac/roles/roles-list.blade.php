    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Roles List</h4>
            ...
            <div class="float-right d-none d-md-block">
                ...
                <div class="dropdown">
                    <a href="{{ url('admin\rbac\roles\create')}}"><button class="btn btn-primary " type="button"
                        ...
                        <i class="mdi mdi-settings mr-2"></i> Create Role
                    </button> </a>
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <table id="tblRole" class="table table-striped table-bordered dt-responsive nowrap"
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/settings/rbac/roles/roles-list.js') }}"></script>
