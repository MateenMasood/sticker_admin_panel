    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Create Policy</h4>
                <ol class="breadcrumb mb-0">
                    <li class="breadcrumb-item"><a href="javascript: void(0);">S Chalet</a></li>
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Policies List</a></li>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formEditPolicy" id="formEditPolicy">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                                ...
                                <select class="form-control select2" id="hotel" name="hotel" reequired>
                                    <option value=" {{ $singleRecord->hotel->id }}"> {{ $singleRecord->hotel->name }} </option>
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Title</label>
                            <input type="text" class="form-control" required placeholder="Please enter days here" name="title" value="{{ $singleRecord->title }}"/>
                        </div>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/settings/policy/policy-edit.js') }}"></script>
