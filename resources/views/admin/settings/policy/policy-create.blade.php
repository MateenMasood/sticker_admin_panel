        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formCreatePolicy" id="formCreatePolicy">
                        @csrf
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="form-group">
                              <label>Title</label>
                            <input type="text" class="form-control" required placeholder="Please enter days here" name="title"/>
                        </div>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/settings/policy/policy-create.js') }}"></script>
