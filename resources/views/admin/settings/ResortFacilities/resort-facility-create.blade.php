        ...
        <div class="col-sm-6">
            <div class="page-title-box">
                ...
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item"><a href="javascript: void(0);">Resort Facilities List</a></li>
                    <li class="breadcrumb-item active">Resort Facility Add</li>
                </ol>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formCreateResortFacility" id="formCreateResortFacility">
                        @csrf
                    ...
                    <div class="row mb-5">
                        ...
                        <label> Resort Facilities images  (<small style="color: red;"> <i> minimum 4 pics required * </i> </small>) </label>
...
<script src="{{ URL::asset('/assets/js/pages/form-validation.init.js') }}"></script>
    ...
    <script src="{{ URL::asset('/assets/admin/settings/resortFacilities/resort-facility-create.js') }}"></script>
