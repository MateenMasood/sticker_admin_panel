                    ...
                    <form class="formCreateStiker" id="formCreateStiker">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    ...
                                    <input type="file"  data-height="200" name="icons[]" id="icons" multiple/>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Title</label>
                                    <input type="text" id="title" class="form-control" placeholder="Please enter stiker title"
                                        name="title" />
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                    <label>Stikers</label>
                                    <input type="file"  data-height="200" name="stikers[]" id="stikers" multiple/>
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="form-group">
                                  <label>Tags</label> <br>
                                  <input type="text" class="form-control-tags-input" data-role="tagsinput"  name="tags" id="tags" />
                            </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/stikers/stiker-create.js') }}"></script>
