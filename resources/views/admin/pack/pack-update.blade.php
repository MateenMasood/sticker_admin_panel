    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">Update Category</h4>
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="formUpdateCategory" id="formUpdateCategory">
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Please enter category title"
                                        name="title" value="{{$singleRecord->title}}"/>
                                </div>
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required
                                        placeholder="" name="identifier" value="{{$singleRecord->identifier}}" readonly />
                                </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" required
                                        placeholder="Please enter category Publisher" name="publisher" value="{{$singleRecord->publisher}}"/>
                                </div>
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/pack/pack-update.js') }}"></script>
