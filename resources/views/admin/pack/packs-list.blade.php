    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">All Categories</h4>
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                ...
                <div class="dropdown">
                    <a href="{{ url('admin\pack\create')}}"><button class="btn btn-primary " type="button"
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/pack/packs-list.js') }}"></script>
