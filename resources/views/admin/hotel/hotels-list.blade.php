    ...
    <div class="row align-items-center">
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                ...
                <div class="dropdown">
                    <a href="{{ url('admin\hotel\create')}}"><button class="btn btn-primary " type="button"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="mdi mdi-settings mr-2"></i> Create Hotel
                    </button> </a>
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/hotel/hotels-list.js') }}"></script>
