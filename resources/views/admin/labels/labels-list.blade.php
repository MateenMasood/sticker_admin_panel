    ...
    <div class="row align-items-center">
        <div class="col-sm-6">
            <div class="page-title-box">
                <h4 class="font-size-18">All Labels</h4>
                <ol class="breadcrumb mb-0">
                    ...
                    <li class="breadcrumb-item active">labels list</li>>
                </ol>
            </div>
        </div>
        ...
        <div class="col-sm-6">
            <div class="float-right d-none d-md-block">
                ...
                <div class="dropdown">
                    <a href="{{ url('admin\label\create')}}"><button class="btn btn-primary " type="button"
                        aria-haspopup="true" aria-expanded="false">
                        <i class="mdi mdi-settings mr-2"></i> Add New Label 
                    </button> </a>
...
@section('script')
    ...
    <script src="{{ URL::asset('/assets/admin/labels/labels-list.js') }}"></script>
