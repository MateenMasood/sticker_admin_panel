            ...
            <div class="row justify-content-center">
                <div class="col-md-8 col-lg-6 col-xl-5">
                            ...
                            <form class="form-horizontal mt-4" method="POST" action="{{ route('login') }}">
                                @csrf
                                    <div class="form-group">
                                        ...
                                        <input name="email" type="email" class="form-control @error('email') is-invalid @enderror" @if(old('email')) value="" @else value="" @endif  id="username" placeholder="Enter email" autocomplete="email" autofocus>
                                        @error('email')
                    ...
                    <div class="mt-5 text-center">
                        ...
                        <p class="mb-0">© <script>document.write(new Date().getFullYear())</script> S Chalet. Crafted with <i class="mdi mdi-heart text-danger"></i> by Pinobal Digital Media & Pr (Pvt) Ltd </p>
                    </div>
